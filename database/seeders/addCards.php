...
class addCards extends Seeder
{
    ...
    public function run()
    {
        User::create([
            'id' => 1,
            'name' => 'Lutece',
            'email' => 'lutece@gmail.com',
            'email_verified_at' => '2001-01-01 00:00:00',
            'password' => '$2y$12$1BsHg1n3bMGgfnVLo/BIT.G/p1d8.ab2iPhWIlJSp4ZGludvFRt6O',
            'remember_token' => '',
            'is_admin' => 1,
        ...
        User::create([
            ...
            'email_verified_at' => '2001-01-01 00:00:00',
            'password' => '$2y$12$rPx.hvyOeco7UVVRJf3cIuVBaOn/YgO7bJlVBQNsAYmVo4PQ0TOzG',
            'remember_token' => '',
            'is_admin' => 0,
            'created_at' => '2001-01-01 00:00:00',
            'updated_at' => '2001-01-01 00:00:00',
